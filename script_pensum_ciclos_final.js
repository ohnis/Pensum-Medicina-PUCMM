...
const materias = [
  ...
  { nombre: "Fundamentos de Medicina", ciclo: "Premédica", requisitos: ["Química Orgánica II", "Laboratorio de Química Orgánica II", "Psicología de la Salud II", "Fundamentos de Metodología de la Investigación", "Biología Celular y Genética", "Español II", "Física II", "Laboratorio de Física II"], desbloquea: ["Destrezas Médicas I", "Bioética Médica"] },
  { nombre: "Ciencias Morfológicas I", ciclo: "Premédica", requisitos: ["Fundamentos de Medicina"], desbloquea: ["Ciencias Morfológicas II", "Destrezas Médicas I"] },
  { nombre: "Ciencias Fisiológicas I", ciclo: "Premédica", requisitos: ["Fundamentos de Medicina"], desbloquea: ["Ciencias Fisiológicas II"] },
  { nombre: "Inmunología I", ciclo: "Premédica", requisitos: ["Fundamentos de Medicina"], desbloquea: ["Inmunología II"] },
  { nombre: "Bioquímica I", ciclo: "Premédica", requisitos: ["Fundamentos de Medicina"], desbloquea: ["Bioquímica II"] },
  { nombre: "Bioestadística", ciclo: "Premédica", requisitos: ["Fundamentos de Medicina"], desbloquea: [] },
  { nombre: "Biología Molecular y Genética", ciclo: "Premédica", requisitos: ["Fundamentos de Medicina"], desbloquea: ["Microbiología y Parasitología"] },
  { nombre: "Epidemiología de Campo", ciclo: "Premédica", requisitos: [], desbloquea: ["Epidemiología Clínica"] },
  { nombre: "Ciencias Morfológicas II", ciclo: "Premédica", requisitos: ["Ciencias Morfológicas I"], desbloquea: ["Fisiopatología I"] },
  { nombre: "Ciencias Fisiológicas II", ciclo: "Premédica", requisitos: ["Ciencias Fisiológicas I"], desbloquea: [] },
  { nombre: "Inmunología II", ciclo: "Premédica", requisitos: ["Inmunología I"], desbloquea: [] },
  { nombre: "Bioquímica II", ciclo: "Premédica", requisitos: ["Bioquímica I"], desbloquea: ["Fisiopatología I", "Farmacología I"] },
  { nombre: "Destrezas Médicas I", ciclo: "Premédica", requisitos: ["Fundamentos de Medicina", "Ciencias Morfológicas I"], desbloquea: ["Destrezas Médicas II", "Medicina Familiar y Comunitaria I"] },
  { nombre: "Inglés para la Salud", ciclo: "Premédica", requisitos: ["Inglés III"], desbloquea: [] },
  { nombre: "Salud Pública", ciclo: "Premédica", requisitos: [], desbloquea: ["Medicina Familiar y Comunitaria I", "Medicina Basada en Evidencia"] },
  { nombre: "Bioética Médica", ciclo: "Premédica", requisitos: ["Fundamentos de Medicina", "Antropología Cristiana"], desbloquea: [] },
  { nombre: "Fisiopatología I", ciclo: "Premédica", requisitos: ["Ciencias Morfológicas II", "Bioquímica II"], desbloquea: ["Fisiopatología II", "Patología I", "Farmacología II y Toxicología"] },
  { nombre: "Farmacología I", ciclo: "Premédica", requisitos: ["Bioquímica II"], desbloquea: ["Farmacología II y Toxicología"] },
  { nombre: "Epidemiología Clínica", ciclo: "Premédica", requisitos: ["Epidemiología de Campo"], desbloquea: ["Medicina Basada en Evidencia"] },
  { nombre: "Microbiología y Parasitología", ciclo: "Premédica", requisitos: ["Biología Molecular y Genética"], desbloquea: ["Patología I", "Farmacología II y Toxicología"] },
  { nombre: "Destrezas Médicas II", ciclo: "Premédica", requisitos: ["Destrezas Médicas I"], desbloquea: ["Salud Mental"] },
  { nombre: "Gestión en Salud", ciclo: "Premédica", requisitos: [], desbloquea: ["Tema de Tesis"] },
  { nombre: "Patología I", ciclo: "Premédica", requisitos: ["Fisiopatología I"], desbloquea: ["Patología II"] },
  { nombre: "Farmacología II y Toxicología", ciclo: "Premédica", requisitos: ["Farmacología I", "Fisiopatología I"], desbloquea: ["Neurociencias Biológicas"] },
  { nombre: "Medicina Familiar y Comunitaria I", ciclo: "Premédica", requisitos: ["Salud Pública", "Destrezas Médicas I"], desbloquea: ["Medicina Familiar y Comunitaria II"] },
  { nombre: "Fisiopatología II", ciclo: "Premédica", requisitos: ["Fisiopatología I"], desbloquea: ["Neurología", "Neurociencias Biológicas"] },
  { nombre: "Medicina Basada en Evidencia", ciclo: "Premédica", requisitos: ["Epidemiología Clínica", "Salud Pública"], desbloquea: ["Tema de Tesis"] },
  { nombre: "Patología II", ciclo: "Ciencias Médicas Básicas", requisitos: ["Patología I"], desbloquea: ["Pediatría I", "Cardiopulmonar", "Ciencias Médicas Básicas Integradas", "Nefrología"] },
  { nombre: "Medicina Familiar y Comunitaria II", ciclo: "Ciencias Médicas Básicas", requisitos: ["Medicina Familiar y Comunitaria I"], desbloquea: ["Medicina Familiar y Comunitaria III"] },
  { nombre: "Salud Mental", ciclo: "Ciencias Médicas Básicas", requisitos: ["Destrezas Médicas II"], desbloquea: ["Pediatría I"] },
  { nombre: "Neurología", ciclo: "Ciencias Médicas Básicas", requisitos: ["Fisiopatología II"], desbloquea: [] },
  { nombre: "Neurociencias Biológicas", ciclo: "Ciencias Médicas Básicas", requisitos: ["Fisiopatología II", "Farmacología II y Toxicología"], desbloquea: ["Pediatría I", "Cardiopulmonar", "Ciencias Médicas Básicas Integradas", "Nefrología", "Geriatría", "Pediatría II"] },
  { nombre: "Tema de Tesis", ciclo: "Ciencias Médicas Básicas", requisitos: ["Gestión en Salud", "Medicina Basada en Evidencia"], desbloquea: ["Anteproyecto de Tesis"] },
  { nombre: "Pediatría I", ciclo: "Ciencias Médicas Básicas", requisitos: ["Patología II", "Salud Mental", "Neurociencias Biológicas"], desbloquea: [] },
  { nombre: "Cardiopulmonar", ciclo: "Ciencias Médicas Básicas", requisitos: ["Patología II", "Neurociencias Biológicas"], desbloquea: [] },
  { nombre: "Ciencias Médicas Básicas Integradas", ciclo: "Ciencias Médicas Básicas", requisitos: ["Patología II", "Neurociencias Biológicas"], desbloquea: ["Hemato/Oncología", "Gastroenterología", "Pediatría II", "Endocrinología y Nutrición", "Obstetricia y Perinatología", "Ginecología", "Urología", "Oto/Oftalmología", "Infectología", "Reumatología", "Cirugía y Anestesia", "Trauma y Ortopedia", "Dermatología"] },
  { nombre: "Anteproyecto de Tesis", ciclo: "Ciencias Médicas Básicas", requisitos: ["Tema de Tesis"], desbloquea: ["Tesis", "Internado de Cirugía", "Internado de Medicina Social, Comunitaria y Familiar", "Internado de Pediatría", "Internado de Ginecología y Obstetricia", "Internado de Psiquiatría", "Internado de Medicina Interna"] },
  { nombre: "Nefrología", ciclo: "Ciencias Médicas Básicas", requisitos: ["Patología II", "Neurociencias Biológicas"], desbloquea: [] },
  { nombre: "Medicina Familiar y Comunitaria III", ciclo: "Ciencias Médicas Básicas", requisitos: ["Medicina Familiar y Comunitaria II"], desbloquea: [] },
  { nombre: "Medicina Legal", ciclo: "Ciencias Médicas Básicas", requisitos: ["Moral Médica"], desbloquea: ["Internado de Cirugía", "Internado de Medicina Social, Comunitaria y Familiar", "Internado de Pediatría", "Internado de Ginecología y Obstetricia", "Internado de Psiquiatría", "Internado de Medicina Interna"] },
  { nombre: "Hemato/Oncología", ciclo: "Ciencias Médicas Básicas", requisitos: ["Ciencias Médicas Básicas Integradas"], desbloquea: ["Internado de Cirugía", "Internado de Medicina Social, Comunitaria y Familiar", "Internado de Pediatría", "Internado de Ginecología y Obstetricia", "Internado de Psiquiatría", "Internado de Medicina Interna"] },
  { nombre: "Geriatría", ciclo: "Ciencias Médicas Básicas", requisitos: ["Neurociencias Biológicas"], desbloquea: ["Internado de Cirugía", "Internado de Medicina Social, Comunitaria y Familiar", "Internado de Pediatría", "Internado de Ginecología y Obstetricia", "Internado de Psiquiatría", "Internado de Medicina Interna"] },
  { nombre: "Gastroenterología", ciclo: "Ciencias Médicas Básicas", requisitos: ["Ciencias Médicas Básicas Integradas"], desbloquea: ["Internado de Cirugía", "Internado de Medicina Social, Comunitaria y Familiar", "Internado de Pediatría", "Internado de Ginecología y Obstetricia", "Internado de Psiquiatría", "Internado de Medicina Interna"] },
  { nombre: "Tesis", ciclo: "Ciencias Médicas Básicas", requisitos: ["Anteproyecto de Tesis"], desbloquea: [] },
  { nombre: "Internado de Cirugía", ciclo: "Ciencias Médicas Básicas", requisitos: ["Tesis"], desbloquea: [] },
  { nombre: "Internado de Medicina Social, Comunitaria y Familiar", ciclo: "Ciencias Médicas Básicas", requisitos: ["Tesis"], desbloquea: [] },
  { nombre: "Internado de Pediatría", ciclo: "Ciencias Médicas Básicas", requisitos: ["Tesis"], desbloquea: [] },
  { nombre: "Internado de Ginecología y Obstetricia", ciclo: "Ciencias Médicas Básicas", requisitos: ["Tesis"], desbloquea: [] },
  { nombre: "Internado de Psiquiatría", ciclo: "Preinternado", requisitos: ["Tesis"], desbloquea: [] },
  { nombre: "Internado de Medicina Interna", ciclo: "Preinternado", requisitos: ["Tesis"], desbloquea: [] },
