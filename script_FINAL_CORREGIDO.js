document.addEventListener("DOMContentLoaded", () => {
  ...
  { nombre: "Gestión en Salud", ciclo: "Ciencias Médicas Básicas", requisitos: [], desbloquea: ["Tema de Tesis"] },
  { nombre: "Patología I", ciclo: "Ciencias Médicas Básicas", requisitos: ["Fisiopatología I"], desbloquea: ["Patología II"] },
  { nombre: "Farmacología II y Toxicología", ciclo: "Ciencias Médicas Básicas", requisitos: ["Farmacología I", "Fisiopatología I"], desbloquea: ["Neurociencias Biológicas"] },
  { nombre: "Medicina Familiar y Comunitaria I", ciclo: "Ciencias Médicas Básicas", requisitos: ["Salud Pública", "Destrezas Médicas I"], desbloquea: ["Medicina Familiar y Comunitaria II"] },
  { nombre: "Fisiopatología II", ciclo: "Ciencias Médicas Básicas", requisitos: ["Fisiopatología I"], desbloquea: ["Neurología", "Neurociencias Biológicas"] },
  { nombre: "Medicina Basada en Evidencia", ciclo: "Ciencias Médicas Básicas", requisitos: ["Epidemiología Clínica", "Salud Pública"], desbloquea: ["Tema de Tesis"] },
...
const aprobadas = new Set();
  ...
  const aprobadas = new Set(guardadas);
